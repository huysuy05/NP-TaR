...
# Load a model for hate speech detection (3-class: normal, offensive, hate)
...
def main():
    print("\n" + "="*60)
    print(f"NULLBENCH EVALUATION: {MODEL_NAME} on HateXplain")
    print("="*60)
    
    print("\nLoading task...")
    task = HateXplainTask(split='test')
    ...
    # Save results
    output_file = f"experiments/{MODEL_NAME}_hatexplain_results.json"
    import os
